    ...
    <section class="d-f jc-c mt+">
        <div class="bxs-01 fxg-1 m">
            <div class="bgc-blue c-white fz-18 p">
                <div class="fw-600">${answers.managerName}</div>
                <div class="ai-c d-f mt--">
                    ...
                    <div class="ml--">Manager</div>
                </div>
            </div>
            <div class="p">
                <div class="bdc-gray bdls-s bdrs-s bdts-s bdw-1 p-">id: 1</div>
                <div class="bdc-gray bdls-s bdrs-s bdts-s bdw-1 p-">email: 1</div>
                <div class="bdc-gray bdbs-s bdls-s bdrs-s bdts-s bdw-1 p-">office number: 1</div>
            </div>
        </div>
    </section>
</body>
